...
--DROP TABLE "DOCU_IMAGE" CASCADE CONSTRAINTS;
...
--DROP TABLE "JOPTITLE" CASCADE CONSTRAINTS;
--DROP TABLE "BOARD_COMMENT" CASCADE CONSTRAINTS;
--DROP TABLE "APPR_REGUL" CASCADE CONSTRAINTS;
--DROP TABLE "APPR" CASCADE CONSTRAINTS;
--DROP TABLE "MAILFILE" CASCADE CONSTRAINTS;
--DROP TABLE "ORDER1" CASCADE CONSTRAINTS;
--DROP TABLE "WAREHOUSE" CASCADE CONSTRAINTS;
--DROP TABLE "ESTIMATE_FILE" CASCADE CONSTRAINTS;
--DROP TABLE "SALE" CASCADE CONSTRAINTS;
--DROP TABLE "DEPOSIT" CASCADE CONSTRAINTS;
--DROP TABLE "SALE_LIST" CASCADE CONSTRAINTS;
--DROP TABLE "ORDER_LIST" CASCADE CONSTRAINTS;
--DROP TABLE "TEAM" CASCADE CONSTRAINTS;
--DROP TABLE "E_LIST" CASCADE CONSTRAINTS;
--DROP TABLE "E_LIST_PRODUCT" CASCADE CONSTRAINTS;
