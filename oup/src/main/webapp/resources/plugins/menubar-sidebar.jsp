...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="${path}/${path}/plugins/fontawesome-free/css/all.min.css">
  <!-- Ionicons -->
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="${path}/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
